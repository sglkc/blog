...
![Old design of the dashboard](/assets/project/hubin/design-old.png)

## New Design

The new design now uses a more formal color scheme with brown accents.

![New design of the dashboard](/assets/project/hubin/dashboard.png)

![New design in Figma](/assets/project/hubin/design.png)
